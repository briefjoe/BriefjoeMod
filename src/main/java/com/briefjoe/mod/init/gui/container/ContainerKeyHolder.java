...
public class ContainerKeyHolder extends Container {
	...
	private IInventory inventoryKeyHolder;

	public ContainerKeyHolder(IInventory inventoryPlayer, IInventory inventoryKeyHolder) {
		this.inventoryKeyHolder = inventoryKeyHolder;

		for (int i = 0; i < 4; i++) {
			this.addSlotToContainer(new SlotKeyHolder(inventoryKeyHolder, i, i * 18 + 53, 17));
		}
