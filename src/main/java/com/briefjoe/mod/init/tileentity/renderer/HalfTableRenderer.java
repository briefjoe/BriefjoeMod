...
public class HalfTableRenderer extends TileEntitySpecialRenderer
{
	...
	{
		TileEntityHalfTable table = (TileEntityHalfTable) tileEntity;
		if (table.getItem() != null)
		{
			...
			GL11.glTranslatef((float) posX + 0.5F + xOffset, (float) posY + 0.5F, (float) posZ + 0.3F + zOffset);
