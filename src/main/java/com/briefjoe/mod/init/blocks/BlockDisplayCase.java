...
public class BlockDisplayCase extends BlockUtilTile {
	...
	public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer player, EnumFacing side, float hitX, float hitY, float hitZ)
	{
		...
		{
			TileEntityDisplayCase tileEntityPlate = (TileEntityDisplayCase) tileEntity;
			...
			if (tileEntityPlate.getItem() != null)
			{
				if (!world.isRemote)
				{
					EntityItem entityItem = new EntityItem(world, pos.getX() + 0.5, pos.getY() + 1.3, pos.getZ() + 0.5, tileEntityPlate.getItem());
