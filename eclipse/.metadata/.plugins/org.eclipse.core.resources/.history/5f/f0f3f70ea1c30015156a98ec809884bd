...
public class BlockKeyHolder extends BlockDirectional implements ITileEntityProvider
{
	public BlockKeyHolder(Material materialIn) 
	{
		super(materialIn);
		this.setStepSound(Block.soundTypeWood);
		this.setHardness(0.5F);
		this.setCreativeTab(BriefjoeMod.tabBriefjoe);
